...
import PlayButton from "../Components/Lyrics/PlayButton";
import ProgressBar from "../Components/Lyrics/ProgressBar";
import TimeStamps from "../Components/Lyrics/TimeStamps";
